"""
Reimplementation of transformer encoder and decoders found @ fairseq/fairseq/models/transformer.py
For continous inputs and outputs such as speech features/representations
"""
