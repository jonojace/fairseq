...
class SpeechAudioCorrectorTask(SpeechToTextTask):
    @staticmethod
    def add_args(parser):
    ...
    def __init__(self, args, src_dict):
        ...
        # TODO instead of loading default dictionary symbols from file,
        # TODO instead use only MFA text graphemes so that embedding table is smaller

        # print("in init of SpeechAudioCorrectorTask!! src_dict", src_dict)
        # print("in init of SpeechAudioCorrectorTask!! src_dict.symbols", src_dict.symbols)
        # print("in init of SpeechAudioCorrectorTask!! src_dict.count", src_dict.count)
        # print("in init of SpeechAudioCorrectorTask!! src_dict.indices", src_dict.indices)

        # add symbols for SAC to dictionary
        self.src_dict.add_symbol("<mask>")
        self.add_hubert_codes(K=100)
    ...
    def add_hubert_codes(self, K):
        """add to src_dict entries for hubert codes
        HUB0 HUB1 ... HUB<k-1>"""
        for i in range(K):
